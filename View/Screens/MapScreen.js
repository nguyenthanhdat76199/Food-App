            ...
            <MapView
                ...
                initialRegion={{
                    ...
                    longitudeDelta: 0.002
                        ...
                        <Image style={{...style.iconMap}} source={require('../../src/assets/maker.png')}/>                
                        ...
                        <Marker description="shipper2 location"
                        coordinate={{latitude: 21.0014971102, longitude: 105.782630751}}>
                        <Image style={{...style.iconMap}} source={require('../../src/assets/shipper.png')}/>
                        <Callout style={{...style.callout}}>
                            <Title style={{...style.title_callout}}>Shipper đang giao đến bạn</Title>
                        </Callout>
                        </Marker>
                        ...
                        <Image style={{...style.iconMap}} source={require('../../src/assets/store.png')}/>                
                        <Callout style={{...style.callout}}>
